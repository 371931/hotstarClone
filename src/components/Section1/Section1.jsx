    ...
    return (
        <section className="section1">
            ...
            <div className="sec1con">
                ...
                <p className="p1sec1">All of these and more now streaming.</p>
                <p className="p2sec1">The Disney Bundle Duo Basic includes Disney+ (With Ads) and Hulu (With Ads). Terms Apply.</p>
                <img src={BrandLogoImg} alt="" className="branlogos"/>
                <p className="endindsec1">View All Plan Options</p>
            </div>
        </section>
    )
}